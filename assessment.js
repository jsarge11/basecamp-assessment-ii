...
var myFriends = ['Taylor', 'Scotty', 'Duce', 'Katie'];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Cooper");
...
var myArrayCopy = myArray.splice(0,4);
...
function evensOnly() {
  var evensArray = myNumbers.filter((item) => item % 2 === 0 );
  return evensArray;
}
